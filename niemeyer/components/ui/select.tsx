...
type SelectTriggerShape = "default" | "pill";
...
function SelectTrigger({
    ...
    return (
        <SelectPrimitive.Trigger
            ...
            data-shape={shape}
            className={cn(
                "flex w-fit items-center justify-between gap-1.5 border border-input bg-transparent py-2 pr-2.5 pl-3",
                ...
                shape === "pill"
                    ? "rounded-full data-[size=sm]:rounded-full"
    ...
    return (
        <SelectPrimitive.Portal>
            <SelectPrimitive.Content
                ...
                className={cn(
                    "relative z-50 min-w-36 overflow-x-hidden overflow-y-auto rounded-lg",
...
function SelectItem({
    ...
    return (
        <SelectPrimitive.Item
            ...
            className={cn(
                "relative flex w-full cursor-default items-center gap-1.5 py-1.5 pr-12 pl-3 text-sm outline-hidden select-none",
...
export type { SelectTriggerShape };
